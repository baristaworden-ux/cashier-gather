...
const assetsSubItems = [
  { tab: '',             label: 'Overzicht',    icon: Home,       href: '/assets' },
  { tab: 'instellingen', label: 'Instellingen', icon: Settings,   href: '/assets?tab=instellingen' },
]
...
export function Sidebar() {
  ...
  function isAssetsSubActive(item: typeof assetsSubItems[number]) {
          ...
          <li>
            ...
            {onAssets && (
              <ul className="mt-0.5 space-y-0.5">
                {assetsSubItems.map(item => {
                  const active = isAssetsSubActive(item)
